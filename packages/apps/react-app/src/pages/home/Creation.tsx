        ...
        <div className='flex flex-col'>
            ...
            <div className='flex flex-1 flex-row justify-between p-4'>
                <div className='flex flex-col w-1/4 items-center'>
                    ...
                    <div className='text-sm my-2 text-gray-700'>回答问题</div>
                </div>
                <div className='flex flex-col w-1/4 items-center'>
                    ...
                    <div className='text-sm my-2 text-gray-700'>发视频</div>
                </div>
                <div className='flex flex-col w-1/4 items-center'>
                    ...
                    <div className='text-sm my-2 text-gray-700'>写文章</div>
                </div>
                <div className='flex flex-col w-1/4 items-center'>
                    ...
                    <div className='text-sm my-2 text-gray-700'>写想法</div>
                </div>
            </div>
            <div className='flex flex-1 flex-row justify-between p-4'>
                <div className=' text-gray-700 bg-gray-100 w-full h-full p-6 rounded-md flex flex-col'>
                    <div>开启你的前端之旅</div>
